  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        <h1 className="font-roboto text-3xl text-center font-bold text-dark-soft md:text-5x1 lg:text-left lg:max-w-[540px]">
          Read the most interesting arcticles
        </h1>
        <p className="text-dark-light mt-4 text-center md:text-xl lg:text-left">
          ...
          voluptatibus culpa vitae sunt nulla pariatur nisi doloremque impedit
          eos.
        </p>
        ...
        <div className="flex mt-4 flex-col lg:flex-row lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7">
          <span className="text-dark-light font-semibold italic mt-2 lg:mt-4 flex-shrink-0">
            Popular Tags:
          </span>
